...
csv_file_location =  'C:\\Users\\Pc\\Downloads\\Compressed\\data\\data\\valid_labels.csv'
...
path = 'C:\\Users\\Pc\\Downloads\\Compressed\\data\\data\\elephant\\test\\valid'
get_image_names_and_label(path, 'elephant')
